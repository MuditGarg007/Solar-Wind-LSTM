...
## STATUS: Phases A–J COMPLETE. Phase J (Kp/ap/AE inputs) ADOPTED — first new-modality win.
...
5. **Interpretability (SHAP / integrated gradients)** — cheap one-time; confirms Bz/speed dominance, validates #9 (model already learned physics). Paper-friendly.
